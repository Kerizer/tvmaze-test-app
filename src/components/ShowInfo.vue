    ...
    <div v-if="props.show">
        <div class="show-main-info">
            ...
            <div class="show-details">
                ...
                <p>Genres: {{ props.show.genres && props.show.genres.length ? props.show.genres?.join(", ") : `N/A` }}</p>
                <p>Status: {{ props.show.status }}</p>
                <p>
                    Official site: 
                    <a v-if="Boolean(props.show.officialSite)" :href="props.show.officialSite">{{ props.show.officialSite}} </a> 
